  ...
  return (
    <>
      <Modal
        ...
        children="Sua senha foi redefinida com sucesso, redirecionando para o login..."
      ></Modal>
      ...
      <div className="container">
        <form className="recuperar-form" onSubmit={handleRecuperacao}>
          ...
          {erro.dados && <div className="erro-mensagem">{erro.dados}</div>}

          {erroToken.dados && (
            <div className="erro-mensagem">{erroToken.dados}</div>
          )}

          {erro.geral && <div className="erro-mensagem">{erro.geral}</div>}
